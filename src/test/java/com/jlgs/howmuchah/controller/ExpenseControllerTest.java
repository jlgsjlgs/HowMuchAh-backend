...
class ExpenseControllerTest {
    ...
    @Test
    @DisplayName("PUT /api/expenses/{expenseId} - Should update expense and return 200")
    void updateExpense_WhenValidRequest_ShouldReturn200() throws Exception {
        // Arrange
        ExpenseUpdateRequest request = new ExpenseUpdateRequest(
                ...
                LocalDate.now(),
                List.of(
                        new ExpenseSplitDto(userId, new BigDecimal("60.00")),
                        new ExpenseSplitDto(UUID.randomUUID(), new BigDecimal("60.00"))
                )
        );
        ...
        when(expenseService.updateExpense(eq(userId), eq(expenseId), any(ExpenseUpdateRequest.class)))
                .thenReturn(response);
        ...
        verify(expenseService, times(1)).updateExpense(eq(userId), eq(expenseId), any(ExpenseUpdateRequest.class));
    }

    @Test
    @DisplayName("PUT /api/expenses/{expenseId} - Should return 400 when user not part of group")
    void updateExpense_WhenUserNotPartOfGroup_ShouldReturn400() throws Exception {
        // Arrange
        ExpenseUpdateRequest request = new ExpenseUpdateRequest(
                "Updated Dinner",
                new BigDecimal("120.00"),
                ...
                "food",
                LocalDate.now(),
                List.of(new ExpenseSplitDto(userId, new BigDecimal("120.00")))
        );

        when(expenseService.updateExpense(eq(userId), eq(expenseId), any(ExpenseUpdateRequest.class)))
                .thenThrow(new IllegalArgumentException("Only group members can update expenses for the group"));
    ...
    @Test
    @DisplayName("PUT /api/expenses/{expenseId} - Should return 400 when expense is settled")
    void updateExpense_WhenExpenseSettled_ShouldReturn400() throws Exception {
        // Arrange
        ExpenseUpdateRequest request = new ExpenseUpdateRequest(
                "Updated Dinner",
                new BigDecimal("120.00"),
        ...
        when(expenseService.updateExpense(eq(userId), eq(expenseId), any(ExpenseUpdateRequest.class)))
                .thenThrow(new IllegalArgumentException("Cannot modify settled expense."));
    ...
    @Test
    @DisplayName("PUT /api/expenses/{expenseId} - Should return 500 when expense not found")
    void updateExpense_WhenExpenseNotFound_ShouldReturn500() throws Exception {
        // Arrange
        ExpenseUpdateRequest request = new ExpenseUpdateRequest(
                "Updated Dinner",
                new BigDecimal("120.00"),
